...
class Usuario extends CI_Controller {
	...
	// pega todos os usuarios do bd e passa para a view	
		...
		$this->load->view('admin/lista_usuario',$data);
	...
	public function cadastro(){
		...
		$this->load->view('admin/includes/menu');
		if(isset($data)){
			$this->load->view('admin/cadastro_usuario',$data);
		}else{
			$this->load->view('admin/cadastro_usuario');
		}
		$this->load->view('admin/includes/footer');
	...
	public function alterar($id=null){
		...
		if(isset($data)){
			...
			$this->load->view('admin/alterar_usuario');
		}
		$this->load->view('admin/includes/footer');
	}
